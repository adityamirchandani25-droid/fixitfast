-- CreateEnum
CREATE TYPE "Role" AS ENUM ('CUSTOMER', 'PROVIDER', 'COMPANY', 'ADMIN');
...
-- CreateIndex
CREATE INDEX "Provider_isOnline_approvalStatus_locationUpdatedAt_idx" ON "Provider"("isOnline", "approvalStatus", "locationUpdatedAt");
