...
export default function Home() {
  ...
  </main><footer className="landing-footer"><Link href="/" aria-label="FixItFast home"><BrandLogo /></Link><span>© {new Date().getFullYear()} FixItFast</span><nav aria-label="Legal" className="flex flex-wrap items-center gap-x-4 gap-y-1"><Link href="/terms" className="hover:underline">Terms of Service</Link><Link href="/privacy" className="hover:underline">Privacy Policy</Link><Link href="/cookies" className="hover:underline">Cookie Policy</Link><Link href="/refunds" className="hover:underline">Refunds</Link></nav><Link href="/worker/signup">Work with FixItFast <ArrowUpRight size={14} /></Link></footer></div>;
}
